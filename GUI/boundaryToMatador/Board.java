 ...
 * @author Ronnie
 */
final class Board extends javax.swing.JFrame {
	...
	private JPanel[][] bgPanels = new JPanel[11][11];
	...
	private void makeDice() {
		try {
			BufferedImage image = ImageIO.read(getClass().getResource("/pics/Dice.png"));
