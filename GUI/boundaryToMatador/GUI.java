...
public final class GUI {
    ...
    /**
     * The file refered to by the path will be used to define the board when it
     * is created. If this method isn't the first method to be called it will
     * have no result.<br>
     * @param path The path to the file which will define the board.
     */
    public static void create(String path) {
        FieldFactory.path = path;
    }
    ...
    public static void addPlayer(String name, int balance, int r, int g, int b) {
        getBC().addPlayer(name, balance, r, g, b);
    }
    /**
     * Adds a player to the board.<br>
     * Max. 6 players.<br>
    ...
    public static void addPlayer(String name, int balance, Color color) {
        getBC().addPlayer(name, balance, color);
    }
     ...
     */
    public static void setNextChanceCardText(String txt) {
        getBC().setNextChanceCardText(txt);
    }
    /**
