...
final class BoardController {
	 ...
	 */
	public void addPlayer(String name, int balance, int r, int g, int b) {
		this.board.addPlayer(name, balance, new Color(r, g, b));
	}
	/**
	 * Adds a player to the board.<br>
	 * A new player with the same color will replace the old.<br>
	...
	public void addPlayer(String name, int balance, Color color) {
		this.board.addPlayer(name, balance, color);
	}
	...
	/**
	 * Sets the next text that will appear in the center when a player lands on a chance field or
	 * when the deck is pressed. This should be done before the player lands on a chance field.
	 * @param txt : String (Mind the length!)<br>
	 */
	public void setNextChanceCardText(String txt) {
		Center.nextChanceCardText = txt;
	}
	/**
