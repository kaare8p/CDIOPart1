...
public final class Car {
    ...
    public static class Builder {
        ...
        private BufferedImage
            paintHorizontalDualColor(BufferedImage img, Color c1, Color c2,
                Type t) {
            for (int y = 0; y < img.getHeight(); y++) {
                for (int x = 0; x < img.getWidth(); x++) {
                    if (img.getRGB(x, y) == PRIMARYCOLORSTANDIN) {
        ...
        private BufferedImage paintCheckered(BufferedImage img, Color c1,
            Color c2) {
        ...
        private BufferedImage
            paintDotted(BufferedImage img, Color c1, Color c2) {
        ...
        static {
            patternImages.put(Pattern.DIAGONAL_DUAL_COLOR,
                "/structures/Diag_dual.png");
            patternImages.put(Pattern.DOTTED, "/structures/Dotted.png");
            patternImages.put(Pattern.CHECKERED, "/structures/Checkered.png");
            patternImages.put(Pattern.ZEBRA, "/structures/Zebra.png");
        }
    }
    ...
    private static final String PATH = "/pics/cars.png";
}
